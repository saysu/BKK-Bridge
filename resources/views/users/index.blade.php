        ...
        <div class="col-md-12 text-center">
            <div class="row">
               ...
               <div class="col-md-6 text-left font-weight-bold">
                ...
                <p><img src="/image/party.png" class="iconusers" alt=""> {{$user->participates->count()}}個、現在参加予定</p>
               </div>
            </div>
        <a href="{{ route('users.edit', $user) }}" type="submit" class="btn btn-bkk">登録情報を編集する</a>
